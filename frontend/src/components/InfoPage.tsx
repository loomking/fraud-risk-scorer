        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <ul className="space-y-4 text-black/60 text-sm">
              <li><strong className="text-black/80">PR-AUC (Headline Metric):</strong> Measures the trade-off between precision and recall. Because our dataset has a highly imbalanced ~3.5% fraud rate, PR-AUC (0.1670 for v2.0.1) is our true headline metric, unlike ROC-AUC which masks false positives behind massive true negative counts.</li>
              <li><strong className="text-black/80">ROC-AUC:</strong> Measures the model's overall ability to rank fraud above legitimate transactions. Our v2.0.1 model achieves an 0.8093 ROC-AUC, demonstrating strong general discriminative power across all possible thresholds.</li>
