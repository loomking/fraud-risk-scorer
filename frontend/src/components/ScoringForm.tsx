...
export default function ScoringForm({ form, setForm, scoring, onScore }: Props) {
  const inputClasses = "w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-white font-mono text-sm focus:outline-none focus:border-[#3054ff] focus:ring-1 focus:ring-[#3054ff] transition-all backdrop-blur-sm";
  const labelClasses = "block text-[11px] font-bold uppercase tracking-wider text-white/50 mb-1.5 font-['Instrument_Sans']";
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-['Instrument_Serif'] text-white mb-6 relative z-10">Score Transaction</h2>
      ...
      <div className="flex flex-col gap-5 relative z-10">
        ...
        >
          {scoring ? (
            ...
            <>
              <span className="font-semibold text-sm font-['Instrument_Sans']">Execute Risk Analysis</span>
